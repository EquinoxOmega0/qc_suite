...
#|									|
#|      Last update by Fernando J. Selman on 2012-11-04                 |
#|									|
#|----------------------------------------------------------------------|
#
...
print "------------------------------------------------"
print "program qc_prepare started"
...
print "reading "+QC_SUITE_DIR+'instrument/'+instrument+'2.dat'
...
print "program qc_prepare terminated"
print "------------------------------------------------" 
